...
function AboutPage() {
  return (
    <div>
        ...
        <p>With <b>insightBox</b>, users will be able to access the times that they sent and receive emails and the days in which they do so. The user will also be able to access key words and topics that they send/receive in their inboxes.</p>
        <p>Another statistic that <b>insightBox</b> can retrieve, are the contacts and which contact is your most popular contact. With these statistics, <b>insightBox</b> will make an insight to help improve your work ethic.</p>
        <h2>Examples</h2>
